                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="info-box"> <span class="info-box-icon bg-aqua"><i class="icon-briefcase"></i></span>
                        <div class="info-box-content"> <span class="info-box-number">1234</span> <span
                                class="info-box-text">New Projects</span> </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xlg-3">
                    <div class="box box-widget widget-user">
                        ...
                        <div class="widget-user-image"> <img class="img-circle" src="dist/img/img3.jpg"
                                alt="User Avatar"> </div>
                        ...
                        <div class="inner">
                            ...
                            <div class="m-b-2"><span class="text-white">35%</span>
                                <div class="progress bg-lightblue">
                                    <div class="progress-bar bg-white" role="progressbar" style="width: 35%; height: 6px;"
                    ...
                    <div class="small-box bg-darkblue text-white">
                        <div class="inner">
                            ...
                            <div class="m-b-2"><span class="text-white">55%</span>
                                <div class="progress bg-lightblue">
                                    <div class="progress-bar bg-white" role="progressbar" style="width: 55%; height: 6px;"
                                        aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="small-box bg-orange">
                        <div class="inner">
                            ...
                            <div class="m-b-2"><span class="text-white">75%</span>
                                <div class="progress bg-lightblue">
                                    <div class="progress-bar bg-white" role="progressbar" style="width: 75%; height: 6px;"
                                        aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="info-box">
                        <div class="box box-widget">
                            <div class="box-header with-border">
                                <div class="user-block"> <img class="img-circle" src="dist/img/img1.jpg"
                                        alt="User Image"> <span class="username"><a href="#">Alexander
                                            Pierce</a></span> <span class="description">Shared publicly - 8:15 AM
                                        Today</span> </div>
                            </div>
                            <div class="box-body"> <img class="img-responsive pad" src="dist/img/img6.jpg"
                                    alt="Photo">
                                ...
                                <button type="button" class="btn btn-default btn-xs"><i class="fa fa-thumbs-o-up"></i>
                                    Like</button>
                                <span class="pull-left text-muted">153 likes - 23 comments</span>
                            </div>
                            <div class="box-footer box-comments">
                                <div class="box-comment"> <img class="img-circle img-sm" src="dist/img/img3.jpg"
                                        alt="User Image">
                                    <div class="comment-text"> <span class="username"> Maria Gonzales <span
                                                class="text-muted pull-left">12:15 PM Today</span> </span> It is a long
                                        established fact that a reader will be distracted. </div>
                                </div>
                            </div>
                            <div class="box-footer">
                                <form action="#" method="post">
                ...
                <div class="col-lg-4 m-b-2">
                    <div id="carouselExampleControls3" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img src="dist/img/img7.jpg"
                                    class="img-responsive img-rounded" alt="User Image"></div>
                            <div class="carousel-item"> <img src="dist/img/img8.jpg" class="img-responsive img-rounded"
                                    alt="User Image"> </div>
                            <div class="carousel-item"> <img src="dist/img/img9.jpg" class="img-responsive img-rounded"
                                    alt="User Image"> </div>
                        </div>
                                ...
                                <div class="carousel-item active">
                                    <div class="col-lg-12 text-center">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio
                                            praesent libero sed cursus ante.</p>
